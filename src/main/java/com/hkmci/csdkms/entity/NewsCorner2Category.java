...
@Entity
@Table(name = "newscorner2_category")
public class NewsCorner2Category {
	...
	public NewsCorner2Category(Long id, String category, String categoryC, Integer isPublic, Integer isDeleted,
