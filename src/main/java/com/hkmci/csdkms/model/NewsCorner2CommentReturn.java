...
public class NewsCorner2CommentReturn implements Serializable{
...
public NewsCorner2CommentReturn() {
		
	}
	
	
	public NewsCorner2CommentReturn(Integer id, Integer postId, Integer createdBy, Date createdAt, Integer isRely2cmnt, String content,
			Integer isDeleted, Integer deletedBy, Date deletedAt, Integer modifiedBy, Date modifiedAt, Integer randId, Integer instId,
			Integer sectionId, Integer showAsAlias, String alias,List<NewsCorner2CommentModel> subComments, Integer liked) {
